            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">การจัดการข้อมูลโต๊ะ</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <!DOCTYPE html>
                                        ...
                                        <body>
                                            <!-- เพิ่มปุ่มย้อนกลับด้านบนของฟอร์ม -->
                                            <a href="tables.php" class="back-button">สร้างโต๊ะ</a>

                                            <!-- ส่วนที่เหลือของโค้ดฟอร์มที่มีอยู่เดิม -->
                                        </body>
                                        <body>
                                            <!-- เพิ่มปุ่มย้อนกลับด้านบนของฟอร์ม -->
                                            <a href="send_order.php" class="back-button">ส่งรายการอาหาร</a>
